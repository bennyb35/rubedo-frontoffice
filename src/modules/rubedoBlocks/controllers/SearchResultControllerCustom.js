angular.module("rubedoBlocks").lazy.controller("SearchResultsControllerCustom",["$scope","$location","$routeParams","$compile","RubedoSearchService",
